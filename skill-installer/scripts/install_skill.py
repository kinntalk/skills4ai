...
def update_registry(dest_root, skill_name, repo_url, subdir, commit_hash):
    ...
    verbose_print('file', operation='Reading registry', path=str(registry_path))
    ...
    verbose_print('state', description=f"Updating registry entry for '{skill_name}'")
    ...
    try:
        verbose_print('file', operation='Writing registry', path=str(registry_path))
