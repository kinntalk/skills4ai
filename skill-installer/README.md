...
python .trae/skills/skill-installer/scripts/install_skill.py https://github.com/user/repo
...
python .trae/skills/skill-installer/scripts/install_skill.py user/repo/subdir
```
...
python .trae/skills/skill-installer/scripts/install_skill.py brainstorming

# Install with category prefix
python .trae/skills/skill-installer/scripts/install_skill.py curated/brainstorming

# Install by alias
python .trae/skills/skill-installer/scripts/install_skill.py <alias>
```
...
**Example:**
```bash
python .trae/skills/skill-installer/scripts/install_skill.py brainstorming planning-with-files systematic-debugging
```
...
```bash
# Search by name
python .trae/skills/skill-installer/scripts/manage_skills.py search pdf

# Search by description keyword
python .trae/skills/skill-installer/scripts/manage_skills.py search debugging

# Search by alias
python .trae/skills/skill-installer/scripts/manage_skills.py search <alias>
```
...
**Example:**
```bash
python .trae/skills/skill-installer/scripts/manage_skills.py info brainstorming
```
...
python .trae/skills/skill-installer/scripts/install_skill.py --yes <skill-with-deps>
```
...
```bash
python .trae/skills/skill-installer/scripts/install_skill.py <source> --path ./custom/skills
```
